...
public class ListAllCommandHandler extends AbstractCommandHandler {
    public ListAllCommandHandler(TaskCliController taskCliController, InputValidator inputValidator, IOMapper ioMapper) {
        super(taskCliController, inputValidator, ioMapper);
    }

    @Override
    public void execute(String[] args) {
        super.inputValidator.validateListArgument(args);

        List<TaskResponse> responses;
        try {
            responses = super.taskCliController.listAllTasks();
            TableViewPrinter.printTableView(responses);
